if !Visual{global.DayAlphaTimer += Tim * !global.Cutscene;global.ShadeAlpha= global.DayAlphaTimer/(DT+NT/2);}else{global.DayAlphaTimer -= Tim * !global.Cutscene;global.ShadeAlpha= global.DayAlphaTimer/(NT);}
